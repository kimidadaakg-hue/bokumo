      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-card border border-bokumo-line/50 p-6 md:p-10">
          ...
          <div className="space-y-6 text-sm text-bokumo-ink/80 leading-relaxed">
            ...
            <section>
              <h2 className="text-base font-bold text-bokumo-ink mb-2">4. アクセス解析ツールについて</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-bokumo-ink mb-2">5. 掲載情報について</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-bokumo-ink mb-2">6. 免責事項</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-bold text-bokumo-ink mb-2">7. プライバシーポリシーの変更</h2>
              <p>
